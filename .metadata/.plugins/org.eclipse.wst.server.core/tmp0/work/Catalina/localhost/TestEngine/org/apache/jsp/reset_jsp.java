 ...
 * Generated at: 2017-11-28 13:11:19 UTC
...
public final class reset_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"panel-body\">\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<form id=\"register-form\" role=\"form\" autocomplete=\"off\" action=\"UserValidateServlet\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tid=\"email\" name=\"email\" value=\"");
      out.print(session.getAttribute("email") );
      out.write("\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" type=\"email\" readonly>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\"><i\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-lock color-blue\"></i></span> <input\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tid=\"password\" name=\"password\" \n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" type=\"password\" placeholder=\"Enter new password\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\"><i\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-lock color-blue\"></i></span> <input\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tid=\"confirm-password\" name=\"confirm-password\" placeholder=\"Confirm Password\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" class=\"hide\" name=\"option\" id=\"token\"\n");
