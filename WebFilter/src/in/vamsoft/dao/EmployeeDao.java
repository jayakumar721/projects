...
public class EmployeeDao implements EmpDao{
  ...
  public List<Department> getAllDept() {
    ...
    try(PreparedStatement preparedStatement = connection.prepareStatement("Select distinct department_id,department_name from departments")){
  ...
  public boolean updateEmployee(Employee emp) {
    ...
    try(PreparedStatement preparedStatement = connection.prepareStatement("update empcopy set fname=?,salary=?,doj=? where empid=? ")) {
